...
const LIGHT = {
  ...
  filterActive: "bg-black",
  filterActiveBorder: "border-black",
  filterActiveText: "text-white",
  amountActive: "bg-black",
  amountActiveBorder: "border-black",
  amountActiveText: "text-white",
  amountActiveSub: "text-zinc-300",
  bottomNav: "bg-white",
  ...
  categorySports: "bg-zinc-200 text-zinc-800",
  categoryStocks: "bg-emerald-100 text-emerald-700",
  payoutText: "text-black",
};
